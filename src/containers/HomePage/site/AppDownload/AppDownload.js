    ...
    return (
        <div>
            <div className='download__app__wrapper'>
                <h2>Tải ứng dụng SkyBound cho Mac OS X?</h2>
                ...
                <p>Website của chúng tôi
                    <a href='http://localhost:3000'> https://skybound.vn </a>
                    hỗ trợ rất tốt hầu hết các thiết bị di động hiện nay. Gần như bạn có thể sử dụng toàn bộ những tính năng tiên tiến nhất của SkyBound tại địa chỉ đó.</p>
                <p>Trân trọng,
                    <br />
                    Đội ngũ SkyBound.
                </p>
