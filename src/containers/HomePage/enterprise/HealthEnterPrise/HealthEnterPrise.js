                    ...
                    <div className='health-enterprise__detail'>
                        ...
                        <div className='health-enterprise__detail__text'>
                            ...
                            <div className={isMoreDesc ? 'enterprise__detail__text__desc enterprise__detail__show_all__desc' : 'enterprise__detail__text__desc'}>
                                ...
                                <p>Chăm sóc sức khỏe nguồn nhân lực cần quan tâm tới cả thể chất và tinh thần cho nhân viên. Điều này không chỉ thể hiện trách nhiệm, sự quan tâm của doanh nghiệp mà còn góp phần vì sự phát triển của công ty bởi nhân viên khỏe, công ty mạnh. Nhằm đáp ứng yêu cầu riêng của từng doanh nghiệp, SkyBound ra mắt dịch vụ gói khám sức khỏe doanh nghiệp hỗ trợ các công ty chăm sóc sức khỏe nhân viên của mình.</p>
                            </div>
                            <p
